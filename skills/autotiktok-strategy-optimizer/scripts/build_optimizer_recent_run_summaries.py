#!/usr/bin/env python3
"""
Build dashboard-facing recent optimizer run summaries from orchestration-cycle artifacts.
"""
...
from optimizer_dashboard_aggregate_lib import (
    build_optimizer_recent_run_summaries_payload,
    load_optimizer_orchestration_cycle_inputs,
    validate_optimizer_recent_run_summaries_payload,
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--aggregate-id",
        default="optimizer-recent-run-summaries.autotiktok.fixture.2026-04-19",
    )
    parser.add_argument("--generated-at", default="2026-04-19T03:37:00Z")
    ...
    try:
        ...
        payload = build_optimizer_recent_run_summaries_payload(
    ...
    print(f"Wrote optimizer recent run summaries to {args.output}")
    return 0
