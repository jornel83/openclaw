#!/usr/bin/env python3
"""
Run the weekly optimizer orchestration job from manifest/bundle/runtime inputs.
"""
...
DEFAULT_OUTPUT = DEFAULT_ROOT / "fixtures" / "optimizer-weekly-job-run.sample.json"
...
def main() -> int:
    ...
    print(f"Wrote weekly optimizer job run to {args.output}")
    return 0
