#!/usr/bin/env python3
"""
Build discovery sourceSnapshots from an AutoTikTok trending output.
"""
...
def main() -> int:
    ...
    parser.add_argument("--schema-version", default="discovery-source-snapshots.v1")
    parser.add_argument(
        "--view",
    ...
    try:
        payload = build_source_snapshots_from_trending(
    ...
    if args.output:
        ...
        print(f"Wrote trending source snapshots to {args.output}")
        return 0
