#!/usr/bin/env python3
"""
Build canonical discovery videoSamples from an AutoTikTok trending output.
"""
...
def main() -> int:
    ...
    parser.add_argument("--schema-version", default="discovery-video-samples.v1")
    parser.add_argument(
        "--view",
    ...
    try:
        payload = build_video_samples_from_trending(
    ...
    if args.output:
        ...
        print(f"Wrote trending video samples to {args.output}")
        return 0
